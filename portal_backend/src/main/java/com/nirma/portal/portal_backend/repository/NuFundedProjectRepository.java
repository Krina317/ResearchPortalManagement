...
public interface NuFundedProjectRepository extends JpaRepository<NuFundedProject, Long> {
     ...
     *
     * Pageable is included so the backend can also support
     * pagination later.
     */
