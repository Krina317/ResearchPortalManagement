...
import ExtProjectFilters from "./ExtProjectFilters";
import ExtProjectToolbar from "./ExtProjectToolbar";
import ExtProjectTable from "./ExtProjectTable";
import {
...
function ExtProjectPaging({
  ...
  const loadProjectData = async () => {
    try {
      ...
      console.error(
        "Error loading external funded projects:",
        err
      );

      setError(
        err.message ||
          "Failed to load external funded projects."
      );
  ...
  // =========================================================
  // RELOAD WHEN FILTER / PAGINATION / SORT CHANGES
  // =========================================================
...
export default ExtProjectPaging;